                ...
                <div class="ex1">  
                    <center>
                        ...
                        <form action="ProductManagement" method="post" name="f1" onsubmit="return validateForm()" enctype="multipart/form-data">
                            ...
                            <tr> 
                                <td>Product ID:</td>
                                <td><input type="text" name="productID" value="${requestScope.product.productID}" readonly="readonly" required/><i id="productIDError" style="color:red;"></i></td>
                            </tr>
                            <tr>
                                <td>Product name:</td>
                            ...
                            <tr>
                                <td>Image:</td>
                                <td><img src="images/${requestScope.product.imageUrl}" width="30%" height="auto"><input type="file" name="photo" accept="images/*"/></td>
                            </tr>
                            <tr>
                                <td>Price:</td>
                                <td><input type="text" name="price" value="<%=(long)product.getPrice()%>" required/><i id="priceError" style="color:red;"></i></td>
                            </tr> 
                            <tr>
                                <td>Quantity:</td>
                            ...
                            <tr>
                                ...
                                <td><textarea name="description" rows="10" cols="60">${requestScope.description}</textarea><i id="descriptionError" style="color:red;"></i></td>
                            </tr>
                            <tr>
                                    ...
                                    <table border="1px">
                                        <tbody>
                                            <c:forEach items="${requestScope.listImg}" var="img">
                                                <tr>
                                                    <td>
                                                        <img src="images/${requestScope.product.productID}/${img}" width="30%" height="auto">
                                                        ${img}
                                                    </td>
                                                </tr>
                                            </c:forEach>
